...
final class Mailer
{
    ...
    private static function quoteHtml(array $quote, string $quoteUrl): string
    {
        return '<!doctype html><html lang="es"><body style="margin:0;background:#eef3f5;font-family:Arial,sans-serif;color:#132530">'
            ...
            . '<div style="margin:24px 0;padding:18px;background:#eef6f6"><span>Total de la propuesta</span><strong style="display:block;margin-top:6px;font-size:25px;color:#071826">' . money_clp($quote['total']) . '</strong></div>'
