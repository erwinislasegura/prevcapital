...
<section class="admin-panel">
    ...
    <?php foreach ($contacts as $contact): ?><tr>
        ...
        <td><strong><?= e($contact['company']) ?></strong><small class="d-block text-muted"><?= !empty($contact['worker_count']) ? e(number_format((int) $contact['worker_count'], 0, ',', '.')) . ' trabajadores' : 'Dotación no informada' ?></small></td><td><?= e($contact['service']) ?></td><td><?= e(date('d/m/Y H:i', strtotime($contact['created_at']))) ?></td>
